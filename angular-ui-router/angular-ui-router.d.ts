...
declare module 'angular-ui-router' {
    ...
    // the types. (@xogeny)
    export type IState = ng.ui.IState;
    export type IStateProvider = ng.ui.IStateProvider;
    export type IUrlMatcher = ng.ui.IUrlMatcher;
    export type IUrlRouterProvider = ng.ui.IUrlRouterProvider;
    export type IStateOptions = ng.ui.IStateOptions;
    export type IHrefOptions = ng.ui.IHrefOptions;
    export type IStateService = ng.ui.IStateService;
    export type IResolvedState = ng.ui.IResolvedState;
    export type IStateParamsService = ng.ui.IStateParamsService;
    export type IUrlRouterService = ng.ui.IUrlRouterService;
    export type IUiViewScrollProvider = ng.ui.IUiViewScrollProvider;
    export type IType = ng.ui.IType;
}
...
declare module ng.ui {
    ...
    interface IStateProvider extends ng.auto.IServiceProvider {
